...
const StyledWrapper = styled.div`
  ...
  .theme-switch__clouds {
    ...
    z-index: 2;
    background-image: 
      radial-gradient(circle at 20% 50%, var(--clouds-color) 1px, transparent 1px),
      radial-gradient(circle at 60% 30%, var(--back-clouds-color) 0.5px, transparent 0.5px);
  ...
  .theme-switch__checkbox:checked ~ .theme-switch__container .theme-switch__stars-container svg {
    opacity: 1;
  }
